...
def make_team(name: str, leader_id: int, mmr: int = 1000, group_size: int = 1) -> Team:
    """Return a :class:`~daoc_bot.models.Team` in the default IDLE state."""
    return Team(name=name, leader_id=leader_id, member_ids=[leader_id], mmr=mmr, group_size=group_size)
